...
public class EnemyPatrolling : BaseState<EnemyStateMachine.EnemyStates>
{
    public EnemyPatrolling(EnemyStateMachine.EnemyStates key, EnemyStateMachine context) : base(key, context)
    {
        Context = context;
    ...
    public override EnemyStateMachine.EnemyStates GetNextState()
    {
        ...
        return EnemyStateMachine.EnemyStates.Walk;
    }
