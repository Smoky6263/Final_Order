...
internal class EnemyFollowPlayer : BaseState<EnemyStateMachine.EnemyWithShieldStates>
{
    public EnemyFollowPlayer(EnemyStateMachine.EnemyWithShieldStates key, EnemyStateMachine context) : base(key, context) 
    {
        Context = context;
